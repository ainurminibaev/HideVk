...
public class DatabaseDialogHelper extends OrmLiteSqliteOpenHelper {

	private static class Holder {
		private static final DatabaseDialogHelper INSTANCE = new DatabaseDialogHelper(
				HideVkApp.getContext());
	}

	public static DatabaseDialogHelper getInstance() {
	...
	public DatabaseDialogHelper(Context context) {
